...
async def role_create(guild: discord.Guild, **kwargs) -> discord.Role:
    ...
    try:
        ...
        raise Errors.ManageRoles(
            original_error=e,
            guild=guild,
            text='WorstBot failed to create a role due to missing the "manage roles" permission',
        )
...
async def role_add(member: discord.Member, role: discord.Role, reason: Optional[str] = None) -> None:
    ...
    try:
        ...
        raise Errors.ManageRoles(
            original_error=e,
            guild=member.guild,
            text='WorstBot failed to add a role due to missing the "manage roles" permission',
        )
...
async def role_remove(member: discord.Member, role: discord.Role, reason: Optional[str] = None) -> None:
    ...
    try:
        ...
        raise Errors.ManageRoles(
            original_error=e,
            guild=member.guild,
            text='WorstBot failed to remove a role due to missing the "manage roles" permission',
        )
...
async def role_edit(role: discord.Role, **kwargs) -> discord.Role:
    ...
    try:
        ...
        raise Errors.ManageRoles(
            original_error=e,
            guild=role.guild,
            text='WorstBot failed to edit a role due to missing the "manage roles" permission',
        )
...
async def role_delete(role: discord.Role, reason: str = None) -> None:
    ...
    try:
        ...
        raise Errors.ManageRoles(
            original_error=e,
            guild=role.guild,
            text='WorstBot failed to delete a role due to missing the "manage roles" permission',
        )
